...
| Operate or repair XTS failures on SBC77 | `docs/sbc77_local_device_automation.md`, `references/openharmony_xts_formal_workflow.md`, `docs/xdevice_runner.md`, `docs/local_device_automation.md`, then query or create the SBC77 oh-auto profile | `oh_autoctl.py`, `oh_xts_xdevice_runner.py`, xDevice queue tools, product genimage scripts |
