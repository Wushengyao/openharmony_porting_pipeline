...
controlled_executor:
  ...
  notes:
    ...
    - RISC-V run_objcopy.py resource-object mappings may be patched only when target evidence contains riscv64 OUTPUT_TARGET and BUILD_ID_LINK_OUTPUT entries
